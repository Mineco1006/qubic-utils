...
pub const ARBITRATOR: QubicId = QubicId([158, 26, 16, 12, 251, 85, 109, 239, 123, 204, 98, 82, 228, 125, 223, 9, 133, 66, 134, 55, 195, 209, 179, 202, 161, 111, 51, 253, 152, 67, 141, 148]);